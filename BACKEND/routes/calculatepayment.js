...
router.get('/getpaymentdetails/:id', calculatePaymentController.getPaymentById);

// 4. Update a payment by ID
router.put('/updatepaymentdetails/:id', calculatePaymentController.updatePaymentById);

// 5. Delete a payment by ID
router.delete('/deletepaymentdetails/:id', calculatePaymentController.deletePaymentById);
